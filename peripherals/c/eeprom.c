...
{
  i2c_status_t status;
	uint8_t addressH = address >> 8;
	uint8_t addressL = address;
  ...
  //==============================================================
	...
	status = i2cSendByte(i2c_base, addressH, I2C_MCS_START | I2C_MCS_RUN);
	if (status)
		return status;
  //==============================================================
  // Send the Lower byte of the address
	// ADD CODE
  //==============================================================
  status = i2cSendByte(i2c_base, addressL,I2C_MCS_RUN);
	if (status)
		return status;
  //==============================================================
